Rails.application.routes.draw do
  ...
  match 'get_project_html' => 'onepage#getProjectHtml', via: :get
  match 'get_top_tags_html' => 'onepage#getTopTagsHtml', via: :get
  match 'get_item_tags_html' => 'onepage#getItemTagsHtml', via: :get
